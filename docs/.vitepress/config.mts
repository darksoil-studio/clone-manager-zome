...
export default withMermaid({
  ...
  base: "/clone-manager-zome",
  title: "Clone Manager Zome",
  description: "Clone Manager zome for holochain apps",
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/darksoil-studio/clone-manager-zome",
      },
    ],
    search: {
      provider: 'local'
